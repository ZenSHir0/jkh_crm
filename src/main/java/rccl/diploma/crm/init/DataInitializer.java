...
public class DataInitializer {
    ...
    private static final String[][] NEWS_DATA = {
            {"Плановое отключение горячей воды", "С 9:00 до 17:00 будет отключена горячая вода в связи с плановыми ремонтными работами на теплотрассе."},
            {"Покраска подъезда №1 завершена", "Все работы выполнены в срок. Просим жильцов соблюдать чистоту в подъезде."},
            {"Собрание жильцов 30 июня", "В 19:00 в холле первого этажа состоится общее собрание. Повестка: ремонт кровли и установка домофонов."},
            {"Замена лифтового оборудования", "С понедельника по пятницу лифт будет недоступен с 10:00 до 14:00. Приносим извинения за неудобства."},
            {"Уборка придомовой территории", "Субботник состоится 15 июня в 10:00. Просим всех желающих присоединиться."},
            {"Новый мастер по сантехнике", "В штат управляющей компании принят новый специалист по сантехнике. Заявки принимаются через портал."},
            {"Установка видеонаблюдения", "В подъездах и на парковке установлены камеры видеонаблюдения для повышения безопасности."},
            {"Ремонт козырька над входом", "Ремонтные работы продлятся 3 дня. Просим использовать запасной вход со стороны двора."},
            {"Тарифы на коммунальные услуги", "С 1 июля вступают в силу новые тарифы на водоснабжение и водоотведение согласно постановлению."},
            {"Дезинфекция подвальных помещений", "Обработка состоится 20 июня. Просим убрать вещи из подвала заблаговременно."},
            {"Проверка газового оборудования", "Специалисты газовой службы посетят квартиры 22–23 июня с 10:00 до 16:00. Просим обеспечить доступ."},
            {"Новые урны во дворе", "Установлены 6 новых урн для раздельного сбора мусора. Просим соблюдать правила сортировки."},
            {"Ремонт асфальтового покрытия", "Ямочный ремонт во дворе запланирован на 18 июня. Парковка будет временно ограничена."},
            {"Перебои с электроснабжением", "В связи с работами на подстанции 19 июня с 13:00 до 15:00 возможны кратковременные отключения."},
            {"Установка новых почтовых ящиков", "В подъезде №2 смонтированы новые почтовые ящики. Ключи можно получить в управляющей компании."},
            {"Опрос жильцов о благоустройстве", "Просим пройти короткий опрос о пожеланиях по благоустройству двора на стенде в подъезде."},
            {"Акция по замене счётчиков", "До конца месяца действует льготная замена счётчиков воды. Заявки через портал."},
            {"Ремонт системы отопления", "Гидравлические испытания теплосети пройдут 25–26 июня. Отопление будет отключено."},
            {"Новая детская площадка", "Монтаж игрового комплекса во дворе завершится к 1 июля. Спасибо за терпение."},
            {"Вывоз крупногабаритного мусора", "Специализированная машина приедет 21 июня в 11:00. Выставляйте крупный мусор к 10:30."},
            {"Антенное оборудование на крыше", "Технические работы на крыше 17 июня могут вызвать кратковременные помехи телесигнала."},
            {"Итоги голосования по парковке", "Большинство жильцов проголосовало за нанесение разметки. Работы запланированы на июль."},
            {"Профилактика домофонов", "Техническое обслуживание домофонной системы 16 июня с 12:00 до 14:00."},
            {"Новый график вывоза мусора", "С 1 июля мусор будет вывозиться ежедневно в 7:00 и 19:00. Просим не выставлять пакеты заранее."},
            {"Ремонт кровли завершён", "Все работы по замене кровельного покрытия выполнены. Гарантия 5 лет."},
            {"Озеленение двора", "Высажены новые кустарники и цветники вдоль дорожек. Просим не топтать газон."},
            {"Смена управляющей компании", "С 1 августа обслуживанием дома займётся УК «Комфорт». Реквизиты для оплаты изменятся."},
            {"Установка шлагбаума", "Въезд во двор будет оборудован шлагбаумом. Пульты распределит УК до 30 июня."},
            {"Ремонт освещения на лестницах", "Заменены все лампы в подъездах на энергосберегающие светодиодные."},
            {"Страхование общего имущества", "Полис страхования общедомового имущества продлён на следующий год."},
            {"Отчёт УК за первый квартал", "Финансовый отчёт управляющей компании размещён на информационном стенде в подъезде."},
            {"Проверка пожарной безопасности", "Инспекция МЧС состоится 24 июня. Просим не загромождать пути эвакуации."},
            {"Ремонт мусоропровода", "Мусоропровод временно закрыт на дезинфекцию. Мусор просим выносить к контейнерам во дворе."},
            {"Новые правила парковки", "С 1 июля парковка на газоне запрещена. Нарушителей будет фиксировать видеокамера."},
            {"Конкурс на лучший балкон", "Принимаем заявки на конкурс «Лучший балкон — 2024». Призы от управляющей компании."},
            {"Замена труб в подвале", "Плановая замена стояков ХВС в подвале 23–24 июня. Холодная вода будет отключена."},
            {"Установка пандуса", "По просьбе жильцов у главного входа смонтирован пандус для маломобильных граждан."},
            {"Ремонт системы вентиляции", "Прочистка вентиляционных каналов состоится 19–20 июня. Доступ в квартиры не требуется."},
            {"Праздник двора 12 июня", "Приглашаем всех жильцов на праздник в честь Дня России. Начало в 15:00 во дворе."},
            {"Новый способ оплаты ЖКУ", "Теперь оплатить квитанции можно через Систему быстрых платежей без комиссии."},
            {"Предупреждение о мошенниках", "Участились случаи мошенничества под видом сотрудников УК. Требуйте удостоверение."},
            {"Ремонт фасада", "Штукатурные работы на фасаде начнутся 1 июля и продлятся около двух недель."},
            {"Горячая линия УК", "Открыта круглосуточная горячая линия для экстренных вызовов: 8-800-XXX-XX-XX."},
            {"Перенос трансформаторной будки", "Работы по переносу ТП запланированы на конец июня. Возможны кратковременные отключения."},
            {"Ремонт водосточных труб", "Специалисты проведут осмотр и ремонт водосточной системы 18 июня."},
            {"Новый подрядчик по уборке", "С июля уборку подъездов и прилегающей территории будет выполнять ООО «Чистый дом»."},
            {"Установка велопарковки", "У главного входа смонтирована велопарковка на 10 мест. Приятных поездок!"},
            {"Итоги субботника", "Благодарим 34 жильцов, принявших участие в субботнике. Собрано 12 мешков мусора."},
            {"Ремонт системы видеонаблюдения", "14–15 июня камеры будут временно отключены на время технического обслуживания."},
            {"Поздравление с Днём соседей", "УК «Уют» поздравляет всех жильцов с Международным днём соседей! Будьте внимательны друг к другу."}
    };
